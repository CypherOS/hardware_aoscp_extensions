...
public class GestureHandler implements HardwareKeyHandler {

    private static final String TAG = GestureHandler.class.getSimpleName();

    private static final String GESTURE_WAKEUP_REASON = "aoscphw-gesture-wakeup";
    ...
    public GestureHandler(final Context context) {
        mContext = context;
        ...
        mGestureWakeLock = mPowerManager.newWakeLock(
                PowerManager.PARTIAL_WAKE_LOCK, "AoscpHwGestureWakeLock");
        ...
        mContext.registerReceiver(mUpdateReceiver,
                new IntentFilter(GestureConstants.UPDATE_GESTURE_ACTIONS));
    }
    ...
    private void launchCamera() {
        ...
        final Intent intent = new Intent(aoscp.content.HardwareIntent.ACTION_SCREEN_CAMERA_GESTURE);
